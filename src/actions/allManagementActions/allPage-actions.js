...
export const handleItemClick = (item) => {
  return (dispatch, getState) => {
    const categories = getState().allPage_reducer.categories;
    const allCategories = getState().allPage_reducer.allCategories;
    const activeCategoryTab = getState().allPage_reducer.activeCategoryTab;
    const categoryId = categories[activeCategoryTab].Id;
    const allPrefs = allCategories.find(
