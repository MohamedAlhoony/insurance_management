...
import ConfirmOTPPage from "./pages/confirmOTP/confirmOTP_page";
...
import RenewSub_page from "./pages/subsManagementPages/renewSub/renewSub_page";
import Entities_Page from "./pages/entitiesManagementPages/entities/entities_page";
import Cars_Page from "./pages/carsManagementPages/cars/cars_page";
...
const Router = () => {
  return (
    <Switch>
      ...
      <ProtectedRoute
        exact
        path="/stores/:storeId/subscription/renew"
        component={RenewSub_page}
      /> */}
      <ProtectedRoute
        exact
        path="/entities/:entityId/vehicals"
        component={Cars_Page}
      />
      <ProtectedRoute exact path="/" component={Entities_Page} />
